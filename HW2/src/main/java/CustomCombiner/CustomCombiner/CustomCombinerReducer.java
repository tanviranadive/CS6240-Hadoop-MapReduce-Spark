...
// Reducer takes input from Combiner (StationId, StationData) and emits (StationId, avgTmin, avgTmax)
public class CustomCombinerReducer extends Reducer<Text, StationData, Text, Text>{
